...
class TweetTableViewCell: UITableViewCell {
    ...
    private let tweetTextContentLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "This is my Mockup tweet. It is going to take multiple lines. I believe some more text is enough but imma just stop right now"
    ...
    @objc private func didTapRShare(){
    ...
    private func configureButtons(){
        ...
        shareButton.addTarget(self, action: #selector(didTapRShare), for: .touchUpInside)
    }
